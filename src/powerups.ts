...
export function spawnPowerup(canvas: HTMLCanvasElement): void {
  const powerupTypes: Powerup['type'][] = ['shield', 'slowmo'];
...
export function updatePowerups(gameSpeed: number): void {
